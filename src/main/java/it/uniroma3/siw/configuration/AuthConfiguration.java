	 ...
	 public static final String DEFAULT_ROLE = "DEFAULT";
		...
		@Autowired
		  ...
		  protected SecurityFilterChain configure(final HttpSecurity httpSecurity) 
		    ...
		    .requestMatchers(HttpMethod.GET,"/","/index","/libro/**","/autore/**","/paginaAutori/**","/paginaRecensioni/**","/recensione/**","/paginaLibri", "/paginaLibri/**", "/formRegistrazione","/formLogin","/css/**", "/immagini/**", "favicon.ico").permitAll()
